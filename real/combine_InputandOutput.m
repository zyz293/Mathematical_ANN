clear;clc;
SV = csvread('C:\Users\DaTui\Desktop\winter_quarter\research\doing\real\SVs_final_normalization.csv',0,1);
par = csvread('C:\Users\DaTui\Desktop\winter_quarter\research\doing\real\real_fit_parameter.csv',1,1);
para = par(:,1:6);
