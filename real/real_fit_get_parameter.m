...
num = length(list);
fid = fopen('real_fit_parameter_new.csv','w');
...
for i = 1 : num
    ...
    path = strcat('C:\Users\DaTui\Desktop\winter_quarter\research\Simulation_results\real\',current_file);
    data = load(path);
    x = log(data(:,1));
    y = data(:,2);
    [fitresult, gof] = real_fit_final(x,y);
    a1 = fitresult.a1;
    a2 = fitresult.a2;
    a3 = fitresult.a3;
    a4 = fitresult.a4;
