...
par = csvread('C:\Users\DaTui\Desktop\winter_quarter\research\doing\imag\real_fit_parameter_poly.csv',1,1);
para = par(:,1:8); % where to make the change
 
fid = fopen('combine_input_output_poly.csv','w');
for i = 1: size(SV,2)
